...
LOCAL_SRC_FILES  := HAL/visidon/libs/armeabi-v7a/libVDBeautyShotAPI.so
...
LOCAL_SHARED_LIBRARIES += libVDBeautyShotAPI
...
#westalgo add begin
LOCAL_CFLAGS += -DWESTALGO_DUALCAMERA_DOF
LOCAL_SHARED_LIBRARIES += libwa_dof
#westalgo add end

#begin add  by xiaodong.liu for task7046375 visidon alg 2018/10/11
LOCAL_C_INCLUDES += $(LOCAL_PATH)/HAL/visidon/inc
LOCAL_CFLAGS += -DTCT_VISIDON_SOLUTION
#end add  by xiaodong.liu for task7046375 visidon alg 2018/10/11
